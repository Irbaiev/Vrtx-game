...
// --- НАЧАЛО ВСТАВКИ: Вставьте этот блок внутрь mockResponses ---

  '/api/common/translations/en': {
    method: 'GET',
    response: {
      "COMMON.MIN_BET": "Min Bet",
      "COMMON.MAX_BET": "Max Bet",
      "COMMON.MAX_PROFIT": "Max Profit",
      "COMMON.PLACEBET.ERROR.ATTENTION": "Attention",
      "COMMON.UNPROCESSED_CODE": "An unexpected error occurred. Please try again.",
      "My bets": "My bets",
      "Limits": "Limits",
      "Rules": "Rules",
      "Exit Game": "Exit Game",
      ...
      "undefined": "Rules text not available"
    }
  },
  ...
  '/api/common/rules': {
      method: 'GET',
      response: {
          rules_html: "<h1>Vortex Game Rules</h1><p>Welcome to Vortex! This is a placeholder for the game rules. You can edit this text inside mock-service-worker.js.</p>"
      }
  },
