        ...
        constructor(t) {
          ((this.settings = {}),
            ...
            (this.fetchRules = async () => {
              ...
              let i = !1;
              try {
                // Используем локальные данные вместо API запросов
                const localRules = {
                  "en": {
                    "vortex": "<blockquote>\n<h2>How to Play?</h2>\n\n<ul>\n\t<li>Select your bet amount using the &quot;+&quot; and &quot;-&quot; buttons and press &quot;Spin&quot; to start the game!</li>\n\t<li>Fill the sectors of the Fire, Earth, and Water elements to achieve the highest payout.</li>\n\t<li>Claim your full winnings by pressing &quot;Cash Out&quot;, or a part of them by pressing &quot;Part PayOut&quot;.</li>\n</ul>\n</blockquote>\n\n<blockquote>\n<h2>Game Details</h2>\n\n<h3>Place Bet</h3>\n\n<p>Select your bet amount by adjusting it with the &quot;+&quot; and &quot;-&quot; buttons.</p>\n\n<h3>Spin</h3>\n\n<p>Press &quot;Spin&quot; to start the reel spin. Note that you can only change the bet after the game ends.</p>\n\n<h3>Hold to Spin</h3>\n\n<p>Instead of pressing the button before each round, simply press and hold the &quot;Spin&quot; button to automatically play continuous rounds until you release it.</p>\n\n<h3>Cash Out</h3>\n\n<p>Press &quot;Cash Out&quot; to collect your winnings. After this, you can start a new game.</p>\n\n<h3>Part PayOut</h3>\n\n<p>Press &quot;Part PayOut&quot; to receive the difference between the last and the penultimate segments in each filled circle to your balance. &quot;Part PayOut&quot; is unavailable if only 1 sector is filled in any circle. To activate the &quot;Part PayOut&quot; button, fill at least 2 sectors in one circle.</p>\n\n<h3>Paytable</h3>\n\n<p><img alt=\"\" src=\"https://turbogames-landing-news-prod.s3.eu-central-1.amazonaws.com/flame_f029c18b58.png?updated_at=2025-06-26T14:20:02.410Z\" style=\"height:60px; width:60px\" /> Fire symbol &ndash; fills 1 segment in the outer (red) ring. Multipliers: x3.9, x12.5, x28, x52, x85, x133, x200, BONUS.<br />\nFill all red sectors (Fire) to start the bonus game with the biggest prize, which is immediately credited to your balance. At the end of the bonus game, all fire ring segments reset to 0.</p>\n\n<p><img alt=\"\" src=\"https://turbogames-landing-news-prod.s3.eu-central-1.amazonaws.com/nature_0a6b9373d8.png?updated_at=2025-06-26T14:20:02.504Z\" style=\"height:60px; width:60px\" /> Earth symbol &ndash; fills 1 segment in the middle (green) ring. Multipliers: x2.5, x7.7, x16, x27.5, x44, + x20.5 Free Cashout.<br />\nFill all green sectors (Earth) and instantly receive a 20.5x payout to your balance. After this, you&rsquo;ll move one step back in the green ring.</p>\n\n<p><img alt=\"\" src=\"https://turbogames-landing-news-prod.s3.eu-central-1.amazonaws.com/water_fde3b5f5cf.png?updated_at=2025-06-26T14:20:02.471Z\" style=\"height:60px; width:60px\" /> Water symbol &ndash; fills 1 segment in the inner (blue) ring. Multipliers: x1.55, x4.85, x10, + x7 Free Cashout.<br />\nFill all blue sectors (Water) and instantly receive a 7.0x payout to your balance. After this, you&rsquo;ll move one step back in the blue ring.</p>\n\n<p><img alt=\"\" src=\"https://turbogames-landing-news-prod.s3.eu-central-1.amazonaws.com/next_time_3370c6d396.png?updated_at=2025-06-26T14:20:02.476Z\" style=\"height:60px; width:60px\" /> Wind symbol is neutral and does not affect the rings. You lose the bet, but the sectors remain filled.</p>\n\n<p><img alt=\"\" src=\"https://turbogames-landing-news-prod.s3.eu-central-1.amazonaws.com/rollback_0ad90fc1c4.png?updated_at=2025-06-26T14:20:02.448Z\" style=\"height:60px; width:60px\" /> Skull symbol &ndash; pushes all rings back by 1 segment.</p>\n\n<h3>Bonus Game</h3>\n\n<p>When all fire segments are filled, the bonus game starts with premium multipliers (&times;100, &times;200, &times;300, &times;400, &times;500), all having an equal chance of appearing.<br />\nAt the end of the bonus game, all fire segments are reset, and you receive the bonus payout plus the sum for all reset fire segments (&times;200).</p>\n</blockquote>\n\n<blockquote>\n<h2>RTP</h2>\n\n<p>The game relies on a coefficient called &quot;RTP&quot; (Return to Player), which is the statistical average of payouts over billions of rounds. Vortex has an RTP of 93.56%&ndash;97.16%.</p>\n</blockquote>\n\n<blockquote>\n<h2>Settings</h2>\n\n<p>To access the settings, click the gear icon in the top right corner of the screen. In the settings, you can:</p>\n\n<ul>\n\t<li>change your nickname;</li>\n\t<li>check the minimum and maximum bet limits;</li>\n\t<li>view the maximum win limits;</li>\n\t<li>enable or disable sound effects;</li>\n\t<li>view your betting history.</li>\n</ul>\n</blockquote>\n\n<blockquote>\n<h2>Disconnection Policy</h2>\n\n<p>We prioritize the safety and satisfaction of our players, even in the case of unexpected internet disconnections. Here&rsquo;s how we handle such situations:</p>\n\n<ul>\n\t<li>If a bet was made after a disconnection, it won&rsquo;t be sent to the server, no funds will be deducted, and the game will not proceed.</li>\n\t<li>If disconnection occurs during an active game, the game state on the server remains unchanged. Players can resume the game once the connection is restored.</li>\n</ul>\n</blockquote>\n\n<blockquote>\n<h2>Version</h2>\n\n<p><p>Game version: &quot;[[version]]&quot;</p></p>\n\n<p><p>RNG version: &quot;[[rng]]&quot;</p></p>\n</blockquote>\n",
                    "vortex_short": "<p>Experience the power of nature in Vortex! Harness the forces of Fire, Earth, and Water to reach new heights!</p>\n"
                  },
                  "ru": {
                    "vortex": "<blockquote>\n<h2>Как играть?</h2>\n\n<ul>\n\t<li>Выберите сумму ставки с помощью кнопок &quot;+&quot; и &quot;-&quot; и нажмите &quot;Spin&quot; для начала игры!</li>\n\t<li>Заполните секторы элементов Огня, Земли и Воды, чтобы достичь максимального выигрыша.</li>\n\t<li>Получите полный выигрыш, нажав &quot;Cash Out&quot;, или его часть, нажав &quot;Part PayOut&quot;.</li>\n</ul>\n</blockquote>\n\n<blockquote>\n<h2>Детали игры</h2>\n\n<h3>Размещение ставки</h3>\n\n<p>Выберите сумму ставки, регулируя её кнопками &quot;+&quot; и &quot;-&quot;.</p>\n\n<h3>Вращение</h3>\n\n<p>Нажмите &quot;Spin&quot;, чтобы начать вращение барабана. Обратите внимание, что вы можете изменить ставку только после окончания игры.</p>\n\n<h3>Удержание для вращения</h3>\n\n<p>Вместо нажатия кнопки перед каждым раундом, просто нажмите и удерживайте кнопку &quot;Spin&quot;, чтобы автоматически играть непрерывные раунды, пока не отпустите её.</p>\n\n<h3>Кешаут</h3>\n\n<p>Нажмите &quot;Cash Out&quot;, чтобы получить выигрыш. После этого вы можете начать новую игру.</p>\n\n<h3>Частичный кешаут</h3>\n\n<p>Нажмите &quot;Part PayOut&quot;, чтобы получить разницу между последним и предпоследним сегментами в каждом заполненном круге на ваш баланс. &quot;Part PayOut&quot; недоступен, если заполнен только 1 сектор в любом круге. Чтобы активировать кнопку &quot;Part PayOut&quot;, заполните как минимум 2 сектора в одном круге.</p>\n\n<h3>Таблица выплат</h3>\n\n<p><img alt=\"\" src=\"https://turbogames-landing-news-prod.s3.eu-central-1.amazonaws.com/flame_f029c18b58.png?updated_at=2025-06-26T14:20:02.410Z\" style=\"height:60px; width:60px\" /> Символ Огня – заполняет 1 сегмент во внешнем (красном) кольце. Множители: x3.9, x12.5, x28, x52, x85, x133, x200, БОНУС.<br />\nЗаполните все красные секторы (Огонь), чтобы запустить бонусную игру с самым большим призом, который немедленно зачисляется на ваш баланс. В конце бонусной игры все сегменты огненного кольца сбрасываются до 0.</p>\n\n<p><img alt=\"\" src=\"https://turbogames-landing-news-prod.s3.eu-central-1.amazonaws.com/nature_0a6b9373d8.png?updated_at=2025-06-26T14:20:02.504Z\" style=\"height:60px; width:60px\" /> Символ Земли – заполняет 1 сегмент в среднем (зеленом) кольце. Множители: x2.5, x7.7, x16, x27.5, x44, + x20.5 Бесплатный кешаут.<br />\nЗаполните все зеленые секторы (Земля) и мгновенно получите выплату x20.5 на ваш баланс. После этого вы отступите на один шаг назад в зеленом кольце.</p>\n\n<p><img alt=\"\" src=\"https://turbogames-landing-news-prod.s3.eu-central-1.amazonaws.com/water_fde3b5f5cf.png?updated_at=2025-06-26T14:20:02.471Z\" style=\"height:60px; width:60px\" /> Символ Воды – заполняет 1 сегмент во внутреннем (синем) кольце. Множители: x1.55, x4.85, x10, + x7 Бесплатный кешаут.<br />\nЗаполните все синие секторы (Вода) и мгновенно получите выплату x7.0 на ваш баланс. После этого вы отступите на один шаг назад в синем кольце.</p>\n\n<p><img alt=\"\" src=\"https://turbogames-landing-news-prod.s3.eu-central-1.amazonaws.com/next_time_3370c6d396.png?updated_at=2025-06-26T14:20:02.476Z\" style=\"height:60px; width:60px\" /> Символ Ветра нейтрален и не влияет на кольца. Вы проигрываете ставку, но секторы остаются заполненными.</p>\n\n<p><img alt=\"\" src=\"https://turbogames-landing-news-prod.s3.eu-central-1.amazonaws.com/rollback_0ad90fc1c4.png?updated_at=2025-06-26T14:20:02.448Z\" style=\"height:60px; width:60px\" /> Символ Черепа – отталкивает все кольца назад на 1 сегмент.</p>\n\n<h3>Бонусная игра</h3>\n\n<p>Когда все огненные сегменты заполнены, начинается бонусная игра с премиальными множителями (&times;100, &times;200, &times;300, &times;400, &times;500), все с равными шансами появления.<br />\nВ конце бонусной игры все огненные сегменты сбрасываются, и вы получаете бонусную выплату плюс сумму за все сброшенные огненные сегменты (&times;200).</p>\n</blockquote>\n\n<blockquote>\n<h2>RTP</h2>\n\n<p>Игра основана на коэффициенте под названием &quot;RTP&quot; (Возврат игроку), который является статистическим средним выплат за миллиарды раундов. Vortex имеет RTP 93.56%&ndash;97.16%.</p>\n</blockquote>\n\n<blockquote>\n<h2>Настройки</h2>\n\n<p>Чтобы получить доступ к настройкам, нажмите на иконку шестеренки в правом верхнем углу экрана. В настройках вы можете:</p>\n\n<ul>\n\t<li>изменить свой никнейм;</li>\n\t<li>проверить минимальные и максимальные лимиты ставок;</li>\n\t<li>просмотреть лимиты максимального выигрыша;</li>\n\t<li>включить или отключить звуковые эффекты;</li>\n\t<li>просмотреть историю ваших ставок.</li>\n</ul>\n</blockquote>\n\n<blockquote>\n<h2>Политика отключения</h2>\n\n<p>Мы приоритизируем безопасность и удовлетворенность наших игроков, даже в случае неожиданных отключений интернета. Вот как мы обрабатываем такие ситуации:</p>\n\n<ul>\n\t<li>Если ставка была сделана после отключения, она не будет отправлена на сервер, средства не будут списаны, и игра не будет продолжена.</li>\n\t<li>Если отключение происходит во время активной игры, состояние игры на сервере остается неизменным. Игроки могут возобновить игру после восстановления соединения.</li>\n</ul>\n</blockquote>\n\n<blockquote>\n<h2>Версия</h2>\n\n<p><p>Версия игры: &quot;[[version]]&quot;</p></p>\n\n<p><p>Версия RNG: &quot;[[rng]]&quot;</p></p>\n</blockquote>\n",
                    "vortex_short": "<p>Почувствуйте силу природы в Vortex! Используйте силы Огня, Земли и Воды, чтобы достичь новых высот!</p>\n"
                  }
                };
                
                // Получаем данные для текущего языка или fallback на английский
                const currentLang = this.language || "en";
                const langData = localRules[currentLang] || localRules["en"];
                
                const r = langData[e]
                    ?.replace(/\[\[rng\]\]/g, this.version.rng)
                    ?.replace(/\[\[version\]\]/g, this.version.game),
                  c = { rules: r, rulesShort: langData[o] };
                return (this.setRules(currentLang, c), c);
              } catch (t) {
                return (
